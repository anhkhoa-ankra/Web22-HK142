  ...
  <nav id="nav" class="navbar navbar-default">
    <div class="nav-background">
      ...
      <div class="navbar-header">
        ...
        <a href="/" class="navbar-brand"><span class="nav-font-color"><span class="glyphicon glyphicon-home" style="padding-left:5px; padding-right:5px;"></span></span></a>
      </div>
        ...
        <ul class="nav navbar-nav nav-font-color">
          ...
          <li class="dropdown">
            ...
            <ul role="menu" class="dropdown-menu nav-background">
              <li>
                <a href="#"><span class="nav-font-color">Action</span></a>
              </li>
              <li class="divider">
              </li>
              <li>
                <a href="#"><span class="nav-font-color">Another action</span></a>
              </li>              
              <li class="divider">
              </li>
              <li>
                <a href="#"><span class="nav-font-color">Something else here</span></a>
              </li>
              <li class="divider">
              </li>
              <li>
                <a href="#"><span class="nav-font-color">Separated link</span></a>
              </li>
              <li class="divider">
              </li>
              <li>
                <a href="#"><span class="nav-font-color">One more separated link</span></a>
              </li>
            </ul>
          </li>
          <li class="dropdown">
